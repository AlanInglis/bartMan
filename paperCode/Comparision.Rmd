...
Note: As this script builds multiple large data frames and has to calculate Friedman's H-statistics numerous times (which is a slow calculation), this script may take some time to complete execution. 

This script is to recreate all individual panels in FIGURE 11:
