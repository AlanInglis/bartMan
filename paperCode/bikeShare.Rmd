...
This script is to recreate FIGURES 12-15:
...
# read data
sbd <- read.csv("https://raw.githubusercontent.com/AlanInglis/bartMan/master/paperCode/SeoulBikeData.csv", sep=",", check.names = F)
...
```{r extractTrees}
# tree df (may take several minutes)
...
# (as this is interactive and is plotted in the 'Viewer' window, 
