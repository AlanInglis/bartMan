...
<!-- badges: end -->
For more detailed information and a comprehensive discussion, please refer to our paper associated with this document, available here:

https://doi.org/10.52933/jdssv.v4i1.79

bartMan is an R-package for investigating and visualising Bayesian Additive Regression
...
BART, dbarts, and bartMachine. A practical example of the package in use can be found in our detailed [vignette](https://alaninglis.github.io/bartMan/articles/bartManVignette.html).
...
You can install the development version from [GitHub](https://github.com/AlanInglis/bartMan) with:
