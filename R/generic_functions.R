...
#'        necessary columns `iteration`, `treeNum`, `var`, and `splitValue`. Generated by \code{extractTreeData}
#'        function for `BART`, `dbarts`, or `bartMachine` models.
#'
...
#'
#' @examples
#' treeDataWithObservations <- getObservations(df, treeData)
#'
#' @export
